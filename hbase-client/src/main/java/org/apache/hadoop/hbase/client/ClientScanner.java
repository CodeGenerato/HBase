...
public abstract class ClientScanner extends AbstractClientScanner {
  ...
  public ClientScanner(final Configuration conf, final Scan scan, final TableName tableName,
    ...
    XTraceUtil.getDebugLogger().log("SCANNER SETTINGS:");
  ...
  protected void loadCache() throws IOException {
    ...
    for (;;) {
      ...
      try {
        ...
        // is already non-null.
        XTraceUtil.getDebugLogger().log("call for load");
        ...
        if (callable.switchedToADifferentReplica()) {
          XTraceUtil.getDebugLogger().log("switched region");
      ...
      XTraceUtil.getDebugLogger().log(resultsToAddToCache.length+" "+numberOfCompleteRows+" "+scanResultCache.numberOfCompleteRows()+" rows loaded in cache");
